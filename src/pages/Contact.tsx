        ...
        <section className="bg-gradient-hero text-primary-foreground py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto opacity-95 animate-fade-in">
              We'd love to hear from you. Reach out for partnerships, volunteering, or donations
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                {/* Donate Section */}
                <Card id="donate" className="bg-gradient-hero text-primary-foreground">
                  <CardHeader>
                  ...
                  <CardContent>
                    <p className="mb-6 opacity-95">
                      Your generous contribution helps us expand our programmes and reach more communities in need.
                    </p>
